  ...
  properties: {
    applications: {
      ...
      properties: {
        native: {
          ...
          items: {
            ...
            properties: {
              country: {
                description:
                  "The country of the app store in which the native application is available",
                type: "string",
                default: "US",
              },
              fingerprints: {
                description:
                  "A set of cryptographic fingerprints used for verifying the native application",
                type: "array",
                default: [],
                items: {
                  description:
                    "A cryptographic fingerprint used for verifying the native application",
                  type: "object",
                  additionalProperties: false,
                  required: ["type", "value"],
                  properties: {
              ...
              id: {
                description:
                  "The identifier used to uniquely identify the native application within its platform",
                type: "string",
                minLength: 1,
              },
              launchUrl: {
              ...
              platform: {
                description:
                  "The software platform on which the native application runs",
                type: "string",
                minLength: 1,
              ...
              url: {
                description:
                  "A URL where the native application is available for installation and/or purchase",
                type: "string",
                format: "uri-reference",
              },
            },
        ...
        preferNative: {
          description:
            "A hint to suggest whether native applications should be preferred over the application",
          type: "boolean",
          default: false,
        },
        web: {
          description:
            "Additional settings related to web application integration",
          type: "object",
          default: {},
          additionalProperties: false,
          properties: {
            facebook: {
              description:
                "Additional settings related to Facebook integration",
              type: "object",
              default: {},
              additionalProperties: false,
              properties: {
            ...
            twitter: {
              ...
              properties: {
                cardType: {
                  description:
                    "The type of Twitter card that should appear when the application is shared",
                  type: "string",
    ...
    colors: {
      ...
      properties: {
        background: {
          description:
            "The background color, used in splash screens, and as a substitute for background images",
          type: "string",
          minLength: 1,
        },
        brand: {
          description:
            "The primary color of the application, used as a default for all other color types",
          type: "string",
          default: "gray",
          minLength: 1,
        },
        ...
        theme: {
          description:
            "The theme color, used primarily to color the UI elements surrounding the application",
          type: "string",
          minLength: 1,
        },
        tile: {
          description:
            "The tile color, used as the background color of tile icons",
          type: "string",
          minLength: 1,
        },
      },
    ...
    definitions: {
      description:
        "Contains definitions relating to the inputs and outputs to be produced",
      type: "object",
      default: {},
      additionalProperties: false,
      properties: {
        ...
        display: {
          ...
          additionalProperties: {
            ...
            properties: {
              ...
              pixelDensity: {
                description:
                  "The pixel density of the display in pixels-per-inch",
                type: "integer",
                default: 72,
                minimum: 1,
              },
              ...
              resolution: {
                description:
                  "The device resolution as reported to the user agent",
                type: "object",
                additionalProperties: false,
                ...
                properties: {
                  horizontal: {
                    description:
                      "The horizontal device resolution as reported to the user agent",
                    type: "integer",
                    minimum: 1,
                  },
                  vertical: {
                    description:
                      "The vertical device resolution as reported to the user agent",
                    type: "integer",
                    minimum: 1,
                  },
                },
            ...
            oneOf: [
              {
                ...
                properties: {
                  options: {
                    description:
                      "The options to use when producing the composite input",
                    type: "object",
                    additionalProperties: false,
                    required: ["layers"],
                    properties: {
                      isMasked: {
                        description:
                          "Whether the input should have a mask applied",
                        type: "boolean",
                        // default: false,
                      },
                      layers: {
                        description:
                          "The layers to compose together into an input",
                        type: "array",
                        items: {
                          description:
                            "A layer that forms part of a composite input",
                          type: "object",
                          additionalProperties: false,
                          required: ["input"],
                          properties: {
                  ...
                  strategy: {
                    description:
                      "The strategy used to find or produce the input",
              ...
              },
              {
                ...
                properties: {
                  options: {
                    description:
                      "The options for finding the input to degrade to",
                    type: "object",
                    additionalProperties: false,
                    required: ["to"],
                    properties: {
              ...
              },
              {
                properties: {
                  options: {
                    description:
                      "The options to use when performing the SVG transformation",
                    type: "object",
                    additionalProperties: false,
                    required: ["input"],
                    properties: {
            ...
            properties: {
              ...
              options: {
                ...
                properties: {
                  isMasked: {
                    description:
                      "Whether the output should have a mask applied",
                    type: "boolean",
                    default: false,
                  },
                  isTransparent: {
                  ...
                  variables: {
                    description:
                      "Additional template variables to pass to templated outputs",
                    type: "object",
                    default: {},
                  },
                },
        ...
        size: {
          ...
          additionalProperties: {
            ...
            properties: {
              ...
              key: {
                description:
                  "A short string that can be used to access outputs produced at this size",
                type: "string",
                minLength: 1,
              },
              orientation: {
        ...
        tag: {
          ...
          additionalProperties: {
            ...
            propertyNames: {
              description:
                "The section of the document where the tags should be placed",
              type: "string",
              minLength: 1,
            },
        ...
        target: {
          description:
            "Defines which outputs and tags are used by each target platform",
          type: "object",
          default: {},
          additionalProperties: false,
          properties: {
    ...
    determiner: {
      description:
        "The word that appears before the application's name in a sentence",
      type: "string",
      default: "",
      enum: ["", "a", "an", "auto", "the"],
    },
    ...
    iarcRatingId: {
      description:
        "The International Age Rating Coalition (IARC) certification code of the application",
      type: "string",
      minLength: 1,
    },
    inputs: {
      description:
        "Defines the paths / module IDs to use when looking for inputs",
      type: "object",
      default: {},
      propertyNames: { $ref: "#/definitions/inputName" },
      additionalProperties: {
        description:
          "A path, or module ID that can be used to locate the input file",
        type: "string",
        minLength: 1,
      },
    },
    ...
    masks: {
      ...
      properties: {
        primary: {
          description:
            "The input to use as a mask when no specific mask has been configured for an output",
          type: "string",
          default: "iconMask",
          minLength: 1,
        },
    ...
    name: {
      description:
        "The name of the application as it is usually displayed to the user",
      type: "string",
      default: "App",
      minLength: 1,
    },
      ...
      properties: {
        ios: {
          ...
          properties: {
            statusBarStyle: {
              description:
                "The status bar style to use when installed as an app on iOS",
              type: "string",
              default: "default",
    ...
    shortName: {
      description:
        "A short version of the application name intended for use when space is limited",
      type: "string",
      minLength: 1,
    },
    tags: {
    ...
    targets: {
      description:
        "Defines which platforms to target when automatically selecting outputs to be produced",
      type: "object",
      default: {},
      additionalProperties: false,
      properties: {
        browser: {
          description:
            "A set of Browserslist queries used when selecting browsers to target",
          type: "array",
          default: ["defaults"],
        },
        installer: {
    ...
    urls: {
      ...
      properties: {
        ...
        start: {
          description:
            "The URL that should be used when the application is launched",
          type: "string",
          default: ".",
          format: "uri-reference",
        },
  ...
  definitions: {
    ...
    tagDefinition: {
      ...
      properties: {
        ...
        predicate: {
          description:
            "A list of tag values that will prevent the tag from being produced if they are falsy",
          type: "array",
          default: [],
        ...
        sortWeight: {
          description:
            "A value that can be used to affect the sorting of the tag within its section",
          type: "integer",
          default: 0,
        },
        tag: {
    ...
    tagValue: {
      description:
        "A value used in tag creation as an attribute value, or predicate",
      type: "string",
      minLength: 1,
    },
    targetOutputs: {
    ...
    targetOutputsByTarget: {
      description:
        "Defines sets of output and tag names for a set of named targets",
      type: "object",
      propertyNames: {
